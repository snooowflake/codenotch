...
Ce fork ajoute un panneau **⚙ Connexions** : Codex, Claude Code, Cursor, Antigravity et crédits API DeepSeek/Grok. Activez les services individuellement ; les clés DeepSeek et Grok sont conservées dans le coffre Windows.
